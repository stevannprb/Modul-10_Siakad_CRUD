...
<div class="bg-white rounded-lg shadow-sm p-6">
    ...
    <form method="GET" action="{{ route('mahasiswa.index') }}" class="mb-6 grid grid-cols-1 md:grid-cols-4 gap-3">
        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari NIM, nama, atau email..." class="md:col-span-2 px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:outline-none">
        ...
        <div class="flex gap-2">
            <button type="submit" class="flex-1 bg-gray-300 hover:bg-gray-400 text-black px-4 py-2 rounded-md">Cari</button>
